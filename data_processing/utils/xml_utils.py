...
def modify2_label_name(input_path):
    # train VOC2012
    # dirs = ['data/all_data','data/train_data-2018-03-07', 'data/train_data-2018-03-16', 'data/train_data-2018-03-19',
    ...
    dirs = ['fusion-09-19_all_resize','fusion-09-20_old_resize','fusion-09-20_resize']
        ...
        for annot in annots:
            try:
                ...
                for element_obj in element_objs:
                    node = element_obj.find('name')
                    class_name = element_obj.find('name').text
                    if class_name == 'ksf-ksfltscnrm-tz-scnr-82':     # 1
                        print(node.text)
                        print(annot)
                        node.text = 'ksf-ksfltscnrm-tz-scnr-82.5g'
                    elif class_name == 'bl-blht-dz-yw-6':  # 1
                            print(node.text)
                            print(annot)
                            node.text = 'bl-blht-dz-yw-6.7g'
                    elif class_name == 'mms-mmsqkl-pz-mmsnnqkld-30':  # 1
                            print(node.text)
                            print(annot)
                            node.text = 'mms-mmsqkl-pz-mmsnnqkld-30.6g'

                write_xml(et, annot)
                        # print(node.text)
                    # elif class_name == 'fd-fd-gz-yw-330ml':  # 1
                    #     print(node.text)
                    #     print(annot)
                    #     node.text = 'fd-fdtsyl-gz-yw-330ml'
                    #     print(node.text)
                    # elif class_name == 'md-md-pz-qn-600ml':  # 1
                    #     print(node.text)
                    #     print(annot)
                    #     node.text = 'md-mdwssyl-pz-qn-600ml'
                    #     print(node.text)
                    # elif class_name == 'ksf-ksfbg-bz-qxnmw-125g':  # 1
                    #     print(node.text)
                    #     print(annot)
                    #     node.text = 'ksf-ksfbg-dz-qxnmw-125g'
                    #     print(node.text)
                    # elif class_name == 'wlj-wljlc-pz-yw-500m':  # 1
                    #     print(node.text)
                    #     print(annot)
                    #     node.text = 'wlj-wljlc-pz-yw-500ml'
                    #     print(node.text)
                    # elif class_name == 'Jdb-jdblc-gz-yw-310ml':  # 1
                    #     print(node.text)
                    #     print(annot)
                    #     node.text = 'jdb-jdblc-gz-yw-310ml'
                    #     print(node.text)

                    # if class_name == 'df-dfqkl-dz-zrqkl-43g':  # 1
                    #     print(node.text)
                    #     print(annot)
                    #     node.text = 'df-dfqkl-dz-zrqkl--43g'
                    #     print(node.text)
...
def get_imagenamge_by_label(input_path):
    data_paths = [os.path.join(input_path,s) for s in ['train_data-2018-04-11-2']]
        ...
        for annot in annots:
            try:
                ...
                for element_obj in element_objs:
                    node = element_obj.find('name')
                    class_name = element_obj.find('name').text
                    if class_name == 'bskl-bskl-pz-yw-600ml':
                        print(annot)
...
if __name__ == "__main__":
    input_path = '/home/syh/tf-faster-rcnn/data/train_data'
