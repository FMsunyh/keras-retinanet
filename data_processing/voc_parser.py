...
def get_data(data_path):
    ...
    # data_paths = [os.path.join(input_path, s) for s in ['train_data-2018-04-12']]
...
def save_mapping(class_mapping):
    ...
    with open('./data_info/mapping_all.json', 'w+') as f:
        json.dump(class_mapping, f,sort_keys=True)
        print('save the class mapping to ./data_info/mapping_52.json')
...
if __name__ == '__main__':
    if args.parent_data and args.datadir:
        ...
        pprint.pprint(class_mapping_sorted)
