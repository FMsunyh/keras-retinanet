...
parser.add_argument('-t', '--txt',help='txt of path', default= '/home/syh/RetinaNet/data_processing/ImageSets/Main/trainval_test.txt')
...
if __name__ == '__main__':
    data_path = os.getcwd()
    save_path = os.path.join(args.input, '标完了')
    main(data_path, save_path)
    print('finished')

"""
cd /home/syh/RetinaNet/data_processing
python crop_commdity.py -i /home/syh/train_data/data/all_train_data -o /home/syh/train_data/data
