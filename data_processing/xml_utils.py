...
def modify2_label_name(input_path):
    ...
    dirs = ['data_52/all_data','data_52/train_data-2018-04-18','data_52/train_data-2018-04-19']
        ...
        for annot in annots:
            try:
                ...
                for element_obj in element_objs:
                    node = element_obj.find('name')
                    class_name = element_obj.find('name').text
                    if class_name == 'hy-hybfbgz-hz-pgw-200ml':     # 1
                        print(node.text)
                        print(annot)
                        node.text = 'hn-hnwssgnyl-gz-yw-250ml'
