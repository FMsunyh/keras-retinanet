...
def get_data(data_path):
    ...
    # image_names = [l.strip().split(None, 1)[0] for l in open(os.path.join(data_path, 'ImageSets', 'Main', 'trainval_test.txt')).readlines()]
    image_names = [l.strip().split(None, 1)[0] for l in open(txt_file).readlines()]
    annots = [os.path.join(annot_path, s+'.xml') for s in image_names]
...
parser.add_argument('-i', '--input',help='directory of data path', default= '/home/syh/train_data/data/all_train_data')
parser.add_argument('-t', '--txt',help='txt of path', default= '/home/syh/train_data/data/all_train_data2/ImageSets/Main/trainval_test.txt')
...
if __name__ == '__main__':
    ...
    txt_file = args.txt
    if args.output=='':
        save_path = os.path.join(args.input, 'crop_commdity2')
    else:
        save_path = os.path.join(args.output, 'crop_commdity2')
...
python crop_commdity.py -i /home/syh/train_data/data/all_train_data -o /home/syh/train_data/data -t /home/syh/train_data/data/all_train_data2/ImageSets/Main/trainval_test.txt
