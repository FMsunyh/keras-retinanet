...
# -----------------------------------------------------
# -*- coding: utf-8 -*-
from visualization.preprocessing.image import read_image_bgr
from visualization.preprocessing.generator import Generator
...
class PascalVocGenerator(Generator):
    def __init__(
        ...
        **kwargs
        ...
        print('{} num_classes:{}'.format(self.set_name,self.num_classes()) )
        print('{} size:{}'.format(self.set_name,self.size()) )
